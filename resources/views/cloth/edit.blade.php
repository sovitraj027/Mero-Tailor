                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="file" class="form-control @error("image") is-invalid @enderror" name="image" id="image" alt="image" value="{{$cloth->image}}">
...
{{--                
               ...
               @endforeach  --}}
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="selectpicker form-control @error('color_id') is-invalid @enderror" name="color_id[]" id="color_id" value="">
